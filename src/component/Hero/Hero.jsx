...
import   heroPng  from "../../assets/fruits/heroPng.png";
import leaf from "../../assets/fruits/leafImage.png";
  ...
  return (
    <section>
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[300px] relative">
        ...
        {/* leaf Image */}
        <div className="absolute top-14 md:top-9 right-1/2 blur-sm opacity-80 rotate-[40deg]">

        <motion.img
        initial={{ opacity: 0, y:-200,rotate: 75 }}
        animate={{ opacity:1,y:0,rotate: 0 }}
        transition={{duration:1,delay:1.5}}
        src={leaf} className="w-full md:max-w-[300px]" />
        </div>
      </div>
    </section>
  )
